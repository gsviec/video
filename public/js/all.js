...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=db6ffc9bb938e78683d998d4f8d53262)
 * Config saved to config.json and https://gist.github.com/db6ffc9bb938e78683d998d4f8d53262
 */
...
$( document ).ready(function() {
    ...
    var $plusDetails = $( '<div class="plus-details">\
                                        <ul >\
                                            <li><a href="#" class="js-add-watch-later"><i class="cvicon-cv-watch-later" aria-hidden="true"></i> Watch Later</a></li>\
    ...
    $(".videolist .v-img").hover( function() {
        ...
        //Add watch video later
        if (e.target.className == 'js-add-watch-later') {
            $.ajax({
                type: "POST",
                url: '/watch-later',
                dataType: 'json',
                ...
                success: function (data) {
                    if (data.error) {
                        $('.m-d-md').append('<div class="alert alert-danger">' + data.error.message + '</div>');
                    } else {
                        $('.m-d-md').append('<div class="alert alert-success">' + data.success.message + '</div>');
                    }
                }
            });
        }
    ...
    $('.js-add-watch-later').on('click mouseover', function (e) {
        e.preventDefault();

    })

    if (!getCookie('hide_subscribe')) {
        setTimeout(showModalSubscribe,10000);
    }
