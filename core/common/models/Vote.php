...
class Vote extends ModelBase
{
     ...
     * @return integer
     */
    public function getPositive($flag = false)
    {
        if ($flag) {
            return $this->positive;
        }
        return $this->setHumanViewNumber($this->positive);
    }
     ...
     * @return integer
     */
    public function getNegative($flag = false)
    {
        if ($flag) {
            return $this->negative;
        }
        return $this->setHumanViewNumber($this->negative);
    }
        ...
        if ($vote->getUsersId()) {
            switch ($object) {
                case Vote::OBJECT_POSTS:
                    return t('You have already voted this post');
                    break;
                default:
                    return t('You have already voted this post reply');
                    break;
            }
        }
        if ($way == 'positive') {
