<div class="row">
    ...
    <div class="col-lg-4 col-sm-6">
        <div class="h-2" style="background: rgb(72, 142, 217) none repeat scroll 0% 0%;"></div>        <h3>
            <a>DevOps 101</a>
        </h3>
        <p>
            Khóa học DevOps này cung cấp cho bạn cho bạn những kỹ năng sữ dụng Terraform, Ansible, JenkinsFile
            khi làm việc với cloud mà cụ thể là AWS Cloud, etc
        </p>
        <p><a>View Course</a></p>
    </div>
    ...
    <div class="col-lg-4 col-sm-6">
        <div class="h-2" style="background: rgb(72, 142, 217) none repeat scroll 0% 0%;"></div>
        <h3>
            <a >Ansible 101</a>
        </h3>
        <p>
    ...
    <div class="col-lg-4 col-sm-6">
        <div class="h-2" style="background: rgba(250, 226, 90, 0.74) none repeat scroll 0% 0%;"></div>
        <h3>
    ...
    <div class="col-lg-4 col-sm-6">
        <div class="h-2" style="background: rgb(72, 142, 217) none repeat scroll 0% 0%;"></div>
        <h3>
            <a href="/playlist/khoa-hoc-wordpress-can-ban">WordPress 101</a>
        </h3>
        <p>
            Trong serie bài học này, bạn sẽ bắt đầu từ những kiến thức cơ bản nhất cực kỳ cần thiết đối với tất cả những người có mong muốn tự làm và quản trị được một website bằng WordPress.</p>

        <p><a href="/playlist/khoa-hoc-wordpress-can-ban" >View Course</a></p>
    </div>
</div>
